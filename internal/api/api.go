...
func (s *Server) routes() http.Handler {
	...
	mux.HandleFunc("GET /api/v1/windows", s.listWindows)
	mux.HandleFunc("GET /api/v1/windows/{name}", s.getWindow)
	mux.HandleFunc("PUT /api/v1/windows/{name}", s.putWindow)
	mux.HandleFunc("DELETE /api/v1/windows/{name}", s.deleteWindow)
